...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'wp-online.herokuapp.com'
  config.app_name = 'WP Online'
  config.mailer.from = 'William Poynter <poynter.william@gmail.com>'
  ...
  #
  config.app_secret = 'zVNos0vA8KepjPv7Xk0WejoAr3tBugMWJk-bH2jfgQOYeOdkMLVLnwxHEHyvULG70wg'
